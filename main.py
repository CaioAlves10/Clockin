...
class TelaLogin(customtkinter.CTk):
    def __init__(self, *args, **kwargs):
        ...
        self.cadastro_button = customtkinter.CTkButton(self, text='CADASTRE-SE', text_color='#3F5B80', fg_color='transparent', bg_color='#D2DDF9', hover=False,
                                                       font=font_link, command=self.open_telaCadastro)
        self.cadastro_button.place(relx=0.5, rely=0.7, anchor=tkinter.CENTER)
